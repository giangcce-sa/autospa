...
const LEGACY_CANONICAL_VIEWS: Readonly<Record<string, string>> = {
...
const ROUTE_DEFINITIONS: readonly AppRoute[] = [
  ...
  { id: "creative-ideas", path: "/creative/ideas", kind: "workspace", workspaceId: "ideas", defaultView: "overview", views: [
    ...
    { id: "research", label: "Nghiên cứu", description: "Thu thập bằng chứng và góc nội dung." },
    { id: "backlog", label: "Kho ý tưởng", description: "Ý tưởng đã lưu để phát triển thành nội dung." },
    { id: "history", label: "Lịch sử", description: "Các lần nghiên cứu và nguồn đã dùng." },
  ...
  { id: "creative-content", path: "/creative/content", kind: "workspace", workspaceId: "content", defaultView: "overview", views: [
    ...
    { id: "editor", label: "Biên tập", description: "Tạo và chỉnh caption theo giọng thương hiệu." },
    { id: "bulk", label: "Hàng loạt", description: "Sản xuất nhiều nội dung theo kế hoạch." },
    { id: "experiments", label: "Thử nghiệm", description: "So sánh các phiên bản nội dung." },
    { id: "review", label: "Kiểm tra", description: "Kiểm tra chất lượng trước khi chuyển bước." },
  ...
  { id: "creative-images", path: "/creative/images", kind: "workspace", workspaceId: "images", defaultView: "overview", views: [
    ...
    { id: "create", label: "Tạo ảnh", description: "Sinh và so sánh các phương án hình ảnh." },
    { id: "library", label: "Thư viện", description: "Tài nguyên hình ảnh đã lưu." },
    { id: "review", label: "Duyệt ảnh", description: "Kiểm tra chất lượng và nhận diện." },
  ...
  { id: "creative-video", path: "/creative/video", kind: "workspace", workspaceId: "video", defaultView: "overview", views: [
    ...
    { id: "projects", label: "Dự án", description: "Storyboard, cảnh, giọng và render." },
    { id: "review", label: "QA & Duyệt", description: "Kiểm tra revision, consent và phê duyệt." },
    { id: "jobs", label: "Công việc", description: "Theo dõi render và publish jobs." },
  ...
  { id: "creative-publishing", path: "/creative/publishing", kind: "workspace", workspaceId: "publishing", defaultView: "overview", views: [
    ...
    { id: "composer", label: "Soạn & Đăng", description: "Review và phân phối nội dung." },
    { id: "calendar", label: "Lịch", description: "Theo dõi nội dung đã lên lịch." },
    { id: "library", label: "Thư viện", description: "Tìm và tái sử dụng nội dung." },
...
export const APP_ROUTES: readonly AppRoute[] = ROUTE_DEFINITIONS.map((route) => {
  ...
  return {
    ...
    kind: "alias",
    canonicalPath,
    canonicalView: route.canonicalView ?? LEGACY_CANONICAL_VIEWS[route.id],
