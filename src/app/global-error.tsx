      ...
      <body style={{ margin: 0, background: "#f4f5f1", color: "#171b16", fontFamily: "system-ui, sans-serif" }}>
        <main style={{ minHeight: "100vh", display: "grid", placeItems: "center", padding: "24px" }}>
          <section style={{ width: "min(100%, 560px)", border: "1px solid #dde2d9", borderRadius: "12px", background: "#fff", padding: "40px", textAlign: "center" }}>
            <p style={{ margin: 0, color: "#6c5ce7", fontSize: "13px", fontWeight: 700 }}>AutoSpa</p>
            ...
            <button type="button" onClick={() => unstable_retry()} style={{ marginTop: "24px", minHeight: "44px", border: 0, borderRadius: "8px", background: "#6c5ce7", color: "#fff", padding: "0 20px", fontSize: "14px", fontWeight: 700, cursor: "pointer" }}>Thử lại</button>
          </section>
        </main>
      </body>
    </html>
