...
import { Flame, PaperPlaneTilt } from "@phosphor-icons/react";

const TABS = [
  { id: "leads", label: "Chốt sale", icon: Flame },
  { id: "proactive", label: "Proactive Outreach", icon: PaperPlaneTilt },
] as const;
...
export function SalePageClient() {
  ...
  return (
    <div className="space-y-4">
      ...
      {tab === "leads" ? <SaleManager /> : <ProactiveOutreach />}
    </div>
  );
}
